...
<link rel="stylesheet" type="text/css"
      href="<?php bloginfo('template_directory'); ?>/scripts/dhtmlxtree/admin/dhtmlxtree.css">
<link rel="stylesheet" type="text/css"
...
<div class="wrap">
    ...
    <a href="javascript:reloadTree();">Reload Tree</a> | <a href="javascript:expandAllTree();">Expand All</a> | <a
        href="javascript:colapseAllTree();">Collapse All</a>
    <br clear="all"/>

    <div id="termsTree"
         style="float: left; width : 400px; height : 400px; position : relative; border 2px solid black;"></div>
    <div id="termDetails">
        <form id="termDetailsForm">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><textarea id="termDetailsForm_description" name="description" cols="40" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" id="termDetailsForm_top_concept" name="top_concept"
                               value="1" <?php if ($page_data->get_value('top_concept')) {
                ...
                <tr>
                    <td>
                        <label for="termDetailsForm_related">
                            Related terms <br/> <em>(drag here terms from tree,<br/>right click to remove, <br/>use
                                CTRL+mouse click to <br/>select multiple items)</em>
                        </label>
                    <td>
                        <select id="termDetailsForm_related" name="related[]" multiple="true" size="10"
                ...
                <tr style="background-color: #F0F0F0;">
                    ...
                    <td>
                        <input type="text" id="syn_suggest" name="syn_suggest" size="40"/><input id="syn_suggest_add"
                                                                                                 type="button"
                                                                                                 value="Add"/>
                        <br/>
                        <select id="termDetailsForm_synonyms" name="synonyms[]" multiple="multiple"
                                style="width: 360px; height: 100px;" size="5">
                        </select>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input id="termDetailsForm_submit" name="actioned" type="button" class="button-primary"
                               value="<?php _e('Save changes', 'informea'); ?>"/>
                        <input id="termDetailsForm_create" name="actioned" type="button" class="button-primary"
                               value="<?php _e('Create term', 'informea'); ?>"/>
                        <input id="termDetailsForm_cancel" name="actioned" type="button" class="button-primary"
                               value="<?php _e('Cancel', 'informea'); ?>"/>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <br clear="all"/>
    <?php if ($expand) { ?>
        <a href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_relationships&id_term=<?php echo $expand; ?>">Go
            back to term edit form</a>
    <?php } ?>
    ...
    <div style="float: left; margin-left: 2em;">
        <ol>
            <li>The tree shows the hierarchical relations between terms, terms filed under another term are narrower
                terms to his parent;
            </li>
            <li>Click on the term and start editing the term. When finished, press '<strong>Save changes</strong>';</li>
            <li>When editing a term, you add 'related terms' by dragging terms from the tree on left, to the 'Related
                terms' area on the right, within editing form;
            </li>
            <li>You can move a term under another term, just drag it to the new position;</li>
            <li>You can unmark a term as narrower, by right-click on term and select 'Unmark term as narrower'. <strong>This
                    will not delete the term</strong>!
            </li>
            <li>In case you get an error message, please <em>refresh the page, and try again</em> or <strong>contact
                    technical support as you may just hit over a bug</strong></li>
            <li>If you want to mark a term as narrower to multiple terms, just right-click on the term, select 'Copy
                term', then right-click on target term and click 'Paste term'. This will duplicate the term as narrower
                to the new parent. Note: Only the term will be copied, excluding its narrower terms.
            </li>
            <li><span style="color: red;"><strong>Warning:</strong> If a term is not appearing anymore it means is not narrower to any other term! Go to <a
                        href="<?php bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_relationships">Manual
                        edit term</a> and select its broader term from there</span></li>
        </ol>
    </div>
    <script type="text/javascript">
