...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_source">Edit vocabulary
            sources</a>
    </div>
    <div id="icon-tools" class="icon32"><br></div>
    <h2>Edit vocabulary sources</h2>
    Vocabulary sources are used to keep track of terms' source. Terms may come from different providers such as CITES,
    CBD etc.
