        ...
        <div class="updated settings-error" id="setting-error-settings_updated">
            <?php if ($page_data->success) { ?>
                <p><strong>Term was successfully created!
                    Add <a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_add_term">new
                        one</a>,
                    go <a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus">back</a>
                    or <a
                        href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_relationships&id_term=<?php echo $last_insert_id; ?>">edit
                        details</a>.</strong></p><?php } ?>
            <?php if (!$page_data->success) { ?>
    ...
    <form action="" method="post">
        ...
        <table>
            <tr>
                ...
                <td><input type="text" size="40" id="term" name="term"
                           value="<?php $page_data->get_value_e('term'); ?>"/></td>
            </tr>
            <tr>
                <td><label for="description">Description</label></td>
                <td><textarea rows="5" cols="40" id="description" name="description"
                              value=""><?php $page_data->get_value_e('description');?></textarea></td>
            </tr>
            <tr>
                <td><label for="reference_url">Reference URL</label></td>
                <td><input type="text" size="60" id="reference_url" name="reference_url"
                           value="<?php $page_data->get_value_e('reference_url'); ?>"/></td>
            </tr>
            <tr>
                <td><label for="tag">Tag (used for tag cloud)</label></td>
                <td><input type="text" size="60" id="tag" name="tag"
                           value="<?php $page_data->get_value_e('tag', TRUE); ?>"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="checkbox" id="top_concept" name="top_concept"
            ...
            <tr>
                ...
                <td><input type="text" size="60" id="geg_tools_url" name="geg_tools_url"
                           value="<?php $page_data->get_value_e('geg_tools_url'); ?>"/></td>
            </tr>
        </table>
        <p>
            * - Required field(s)
