...
<div class="wrap">
    ...
    <p>
        This page allows you to create a 'clone' of a term. The new term will be assigned to the same paragraphs,
        decisions etc. as the old term, having only different text (value).
        <br/>
        Managers will clone terms to new ones and then assign them accordingly to other paragraphs, avoiding to do all
        the work twice for new terms.
    </p>
        ...
        <div class="updated settings-error" id="setting-error-settings_updated">
            <?php if ($page_data->success) { ?>
                <p>
                    ...
                    <a href="<?php echo get_bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_relationships&id_term=<?php echo $last_insert_id; ?>">Edit
                        details</a>
                </p>
            <?php } ?>
            <?php if (!$page_data->success) { ?>
    ...
    <form action="" method="post">
        ...
        <div class="field">
            ...
            <input class="input" type="text" size="42" id="term" name="term"
                   value="<?php echo get_request_value('term'); ?>"/>
        </div>
        <div class="field">
            <label for="description">Description</label>
            <textarea class="input" rows="5" cols="40" id="description" name="description"
                      value=""><?php echo get_request_value('description');?></textarea>
        </div>
