...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_merge_terms">Merge two terms
            into one</a>
    </div>
    ...
    <ol>
        <li>
            From this page select the <strong>merged</strong> and the <strong>destination</strong> term and press
            <strong>Merge</strong>.
            <em style="text-decoration: underline">Destination term will replace merged term and remove it entirely from
                database!</em>
        </li>
