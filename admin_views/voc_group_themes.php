...
<div class="wrap">
    <div id="breadcrumb">
        ...
        &raquo;
        <a href="<?php echo bloginfo('url'); ?>/wp-admin/admin.php?page=thesaurus&act=voc_group_themes">Group themes
            into generic/substantives</a>
    </div>
            ...
            foreach ($themes as $term) {
                if ($term->substantive == 0) {
                    ...
                    <li id="theme-<?php echo $term->id; ?>" class="button-secondary action">
                        <?php echo $term->term;?>
                        <input type="hidden" id="input-sort-theme-<?php echo $term->id; ?>"
                               name="theme-sort-<?php echo $term->id; ?>" value="<?php echo $term->order; ?>"/>
                        <input type="hidden" id="input-group-theme-<?php echo $term->id; ?>"
                               name="theme-group-<?php echo $term->id; ?>" value="<?php echo $term->substantive; ?>"/>
                    </li>
                <?php
                }
            }
